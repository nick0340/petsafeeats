...
import { foodDatabase, categories } from '../data/foods';
    ...
    <div>
      ...
      {showMobileSearch && (
        <div className="fixed top-14 sm:top-16 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-lg px-3 py-2 md:hidden animate-slide-down">
          <SearchBar currentPet="dogs" variant="sticky" showTrending={false} />
        </div>
      )}
        ...
        <div className="container-main section-spacing">
          <div className="max-w-[800px] mx-auto">
            ...
            <motion.div
              ...
              className="mt-10"
            >
              <SearchBar currentPet="dogs" variant="hero" showTrending={true} />
            </motion.div>
      ...
      <section className="bg-slate-50 section-spacing">
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 max-w-4xl mx-auto">
            {allPets.map((pet, i) => (
              <Link href={`/${pet.id}`} key={pet.id} passHref legacyBehavior>
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="card-soft rounded-2xl p-6 text-center cursor-pointer group h-full relative overflow-hidden block"
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {toxicFoods.slice(0, 5).map((food, i) => (
              <Link href={`/can-dogs-eat-${food.slug}`} key={food.id} passHref legacyBehavior>
                <motion.a
                  ...
                  className="card-soft bg-danger-light/30 border-danger/10 rounded-xl p-6 text-center cursor-pointer block"
              ...
              {safeFoods.slice(0, 5).map((food, i) => (
                <Link href={`/can-dogs-eat-${food.slug}`} key={food.id} passHref legacyBehavior>
                  <motion.a
                    ...
                    transition={{ delay: 0.1 * i }}
                    whileHover={{ scale: 1.05, y: -4 }}
                    className="card-soft bg-safe-light/30 border-safe/10 rounded-xl p-6 text-center cursor-pointer block"
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-4">
            {categories.map((cat, i) => (
              <Link href={`/category/${cat.id}`} key={cat.id} passHref legacyBehavior>
                <motion.a
                  ...
                  className={`card-soft rounded-xl p-5 text-center cursor-pointer group relative overflow-hidden block ${
