...
import { getRelatedFoods, isMedication, getPetData, generatePetFaqs, type FoodItem, type PetType } from '../data/foods';
            ...
            {petInfo.hasFullData && (
              <>
                ...
                {(petData.safety === 'toxic' || petData.safety === 'caution') && !isHumanMedication && (
                  <SmartAlternatives food={food} pet={pet} onSelect={onSelectFood} />
                )}
